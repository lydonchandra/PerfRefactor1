...
; Assembly listing for method DnaLib.bla:CompressSimdInlined(System.ReadOnlySpan`1[ubyte]):<unnamed>
...
G_M000_IG02:                ;; offset=0011H
       ...
       48BF8817E72E177F0000 mov      rdi, 0x7F172EE71788
       E88DF85D7E           call     CORINFO_HELP_NEWARR_1_VC
       488B3DFE061F00       mov      rdi, qword ptr [(reloc 0x7f172ef64ba8)]
       C5FE6F07             vmovdqu  ymm0, ymmword ptr[rdi]
       33FF                 xor      edi, edi
       85DB                 test     ebx, ebx
       0F8E99010000         jle      G_M000_IG36
       85DB                 test     ebx, ebx
       0F8CC5000000         jl       G_M000_IG20
       395808               cmp      dword ptr [rax+08H], ebx
       0F8CBC000000         jl       G_M000_IG20
...
G_M000_IG06:                ;; offset=0075H
       884C3010             mov      byte  ptr [rax+rsi+10H], cl
...
G_M000_IG18:                ;; offset=00F3H
       FFC7                 inc      edi
       3BFB                 cmp      edi, ebx
       0F8C4CFFFFFF         jl       G_M000_IG03

G_M000_IG19:                ;; offset=00FDH
       E9CC000000           jmp      G_M000_IG36

G_M000_IG20:                ;; offset=0102H
       8BD7                 mov      edx, edi
       410FB61416           movzx    rdx, byte  ptr [r14+rdx]
       83FA61               cmp      edx, 97
       7C06                 jl       SHORT G_M000_IG22

G_M000_IG21:                ;; offset=010EH
       83E2DF               and      edx, -33
       0FB6D2               movzx    rdx, dl

G_M000_IG22:                ;; offset=0114H
       C5F96ECA             vmovd    xmm1, edx
       C4E27D78C9           vpbroadcastb ymm1, ymm1
       C5FD74C9             vpcmpeqb ymm1, ymm0, ymm1
       C5FDD7C9             vpmovmskb ecx, ymm1
       F30FBCC9             tzcnt    ecx, ecx
       83F920               cmp      ecx, 32
       7414                 je       SHORT G_M000_IG24

G_M000_IG23:                ;; offset=012EH
       3B7808               cmp      edi, dword ptr [rax+08H]
       0F839C000000         jae      G_M000_IG37
       8BD7                 mov      edx, edi
       884C1010             mov      byte  ptr [rax+rdx+10H], cl
       E97F000000           jmp      G_M000_IG35

G_M000_IG24:                ;; offset=0142H
       83FA4F               cmp      edx, 79
       7725                 ja       SHORT G_M000_IG26
       83FA42               cmp      edx, 66
       7714                 ja       SHORT G_M000_IG25
       8D72D3               lea      esi, [rdx-2DH]
       83FE01               cmp      esi, 1
...
G_M000_IG28:                ;; offset=0189H
       B914000000           mov      ecx, 20
       EB26                 jmp      SHORT G_M000_IG34

G_M000_IG29:                ;; offset=0190H
       B904000000           mov      ecx, 4
       EB1F                 jmp      SHORT G_M000_IG34

G_M000_IG30:                ;; offset=0197H
       B906000000           mov      ecx, 6
       EB18                 jmp      SHORT G_M000_IG34

G_M000_IG31:                ;; offset=019EH
       B915000000           mov      ecx, 21
       EB11                 jmp      SHORT G_M000_IG34

G_M000_IG32:                ;; offset=01A5H
       83FA20               cmp      edx, 32
       7F07                 jg       SHORT G_M000_IG33
       B9FF000000           mov      ecx, 255
       EB05                 jmp      SHORT G_M000_IG34

G_M000_IG33:                ;; offset=01B1H
       B9FE000000           mov      ecx, 254

G_M000_IG34:                ;; offset=01B6H
       3B7808               cmp      edi, dword ptr [rax+08H]
       7318                 jae      SHORT G_M000_IG37
       8BF7                 mov      esi, edi
       884C3010             mov      byte  ptr [rax+rsi+10H], cl

G_M000_IG35:                ;; offset=01C1H
       FFC7                 inc      edi
       3BFB                 cmp      edi, ebx
       0F8C37FFFFFF         jl       G_M000_IG20

G_M000_IG36:                ;; offset=01CBH
       C5F877               vzeroupper
       5B                   pop      rbx
       415E                 pop      r14
       5D                   pop      rbp
...
G_M000_IG37:                ;; offset=01D3H
       E818595E7E           call     CORINFO_HELP_RNGCHKFAIL
       CC                   int3
